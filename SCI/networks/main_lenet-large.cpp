...
/* Variable to read the clear value corresponding to the input variable tmp0 at (8867,1-8867,38) */
...
uint64_t* tmp1 = make_array<uint64_t>( (int32_t)5,  (int32_t)5,  (int32_t)1,  (int32_t)32);
...
/* Variable to read the clear value corresponding to the input variable tmp5 at (8882,1-8882,41) */
uint64_t __tmp_in_tmp5;
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)3136; i0++){
...
/* Variable to read the clear value corresponding to the input variable tmp6 at (8885,1-8885,35) */
...
/* Variable to read the clear value corresponding to the input variable tmp7 at (8888,1-8888,39) */
...
uint64_t* tmp12 = make_array<uint64_t>( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)32);
#if USE_CHEETAH
  kIsSharedInput = false;
#endif
Conv2DWrapper( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)1,  (int32_t)5,  (int32_t)5,  (int32_t)32,  (int32_t)2,  (int32_t)2,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)1, tmp10, tmp1, tmp12);
#if USE_CHEETAH
  kIsSharedInput = true;
#endif
...
ScaleUp1( (int32_t)32, tmp2, kScale);

uint64_t* tmp15 = make_array<uint64_t>( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)32);
...
Arr4DIdxRowM(tmp15, (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32,i0,i1,i2,i3) = SecretAdd(Arr4DIdxRowM(tmp12, (int32_t)1, (int32_t)28, (int32_t)28, (int32_t)32,i0,i1,i2,i3), Arr1DIdxRowM(tmp2, (int32_t)32,i3));
}
}
}
}
ClearMemSecret1( (int32_t)32, tmp2);
ClearMemSecret4( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)32, tmp12);

uint64_t* tmp18 = make_array<uint64_t>( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)32);
MaxPool( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)32,  (int32_t)2,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)32, tmp15, tmp18);
ClearMemSecret4( (int32_t)1,  (int32_t)28,  (int32_t)28,  (int32_t)32, tmp15);

uint64_t* tmp20 = make_array<uint64_t>( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)32);
Relu4( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)32, tmp18, tmp20,  kScale, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)32, tmp18);

uint64_t* tmp22 = make_array<uint64_t>( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)64);
Conv2DWrapper( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)32,  (int32_t)5,  (int32_t)5,  (int32_t)64,  (int32_t)2,  (int32_t)2,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)1, tmp20, tmp3, tmp22);
ClearMemSecret4( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)32, tmp20);
ClearMemSecret4( (int32_t)5,  (int32_t)5,  (int32_t)32,  (int32_t)64, tmp3);
ScaleUp1( (int32_t)64, tmp4, kScale);

uint64_t* tmp25 = make_array<uint64_t>( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)64);
for (uint32_t i0 =  (int32_t)0; i0 <  (int32_t)1; i0++){
...
Arr4DIdxRowM(tmp25, (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)64,i0,i1,i2,i3) = SecretAdd(Arr4DIdxRowM(tmp22, (int32_t)1, (int32_t)14, (int32_t)14, (int32_t)64,i0,i1,i2,i3), Arr1DIdxRowM(tmp4, (int32_t)64,i3));
}
}
}
}
ClearMemSecret1( (int32_t)64, tmp4);
ClearMemSecret4( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)64, tmp22);

uint64_t* tmp28 = make_array<uint64_t>( (int32_t)1,  (int32_t)7,  (int32_t)7,  (int32_t)64);
MaxPool( (int32_t)1,  (int32_t)7,  (int32_t)7,  (int32_t)64,  (int32_t)2,  (int32_t)2,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)0,  (int32_t)2,  (int32_t)2,  (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)64, tmp25, tmp28);
ClearMemSecret4( (int32_t)1,  (int32_t)14,  (int32_t)14,  (int32_t)64, tmp25);

uint64_t* tmp30 = make_array<uint64_t>( (int32_t)1,  (int32_t)7,  (int32_t)7,  (int32_t)64);
Relu4( (int32_t)1,  (int32_t)7,  (int32_t)7,  (int32_t)64, tmp28, tmp30, kScale, 1);
ClearMemSecret4( (int32_t)1,  (int32_t)7,  (int32_t)7,  (int32_t)64, tmp28);
...
uint64_t* tmp33 = make_array<uint64_t>( (int32_t)1,  (int32_t)3136);
...
for (uint32_t i11 =  (int32_t)0; i11 <  (int32_t)3136; i11++){
Arr2DIdxRowM(tmp33, (int32_t)1, (int32_t)3136,i10,i11) = Arr4DIdxRowM(tmp30, (int32_t)1, (int32_t)7, (int32_t)7, (int32_t)64,i6,i7,i8,i9);
i9 = (i9 +  (int64_t)1);
if ((i9 ==  (int64_t)64)) {
i9 =  (int64_t)0;
i8 = (i8 +  (int64_t)1);
...
ClearMemSecret4( (int32_t)1,  (int32_t)7,  (int32_t)7,  (int32_t)64, tmp30);

uint64_t* tmp35 = make_array<uint64_t>( (int32_t)1,  (int32_t)512);
MatMul2D( (int32_t)1,  (int32_t)3136,  (int32_t)512, tmp33, tmp5, tmp35, 0);
ClearMemSecret2( (int32_t)3136,  (int32_t)512, tmp5);
ClearMemSecret2( (int32_t)1,  (int32_t)3136, tmp33);
...
Arr2DIdxRowM(tmp38, (int32_t)1, (int32_t)512,i0,i1) = SecretAdd(Arr2DIdxRowM(tmp35, (int32_t)1, (int32_t)512,i0,i1), Arr1DIdxRowM(tmp6, (int32_t)512,i1));
}
}
...
Relu2( (int32_t)1,  (int32_t)512, tmp38, tmp41, kScale, 1);
ClearMemSecret2( (int32_t)1,  (int32_t)512, tmp38);

uint64_t* tmp43 = make_array<uint64_t>( (int32_t)1,  (int32_t)10);
MatMul2D( (int32_t)1,  (int32_t)512,  (int32_t)10, tmp41, tmp7, tmp43, 0);
...
ScaleDown2( (int32_t)1,  (int32_t)10, tmp46,  kScale);
EndComputation();
for (uint32_t i0 =  (uint32_t)0; i0 <  (int32_t)1; i0++){
for (uint32_t i1 =  (uint32_t)0; i1 <  (int32_t)10; i1++){
cout << (funcReconstruct2PCCons(Arr2DIdxRowM(tmp46, (int32_t)1, (int32_t)10,i0,i1), 2)) << endl;
}
}
}
