...
/* Variable to read the clear value corresponding to the input variable tmp5 at (8882,1-8882,40) */
...
ScaleUp1( (int32_t)16, tmp2, kScale);
...
Relu4( (int32_t)1,  (int32_t)12,  (int32_t)12,  (int32_t)16, tmp18, tmp20,  kScale, 1);
...
Relu4( (int32_t)1,  (int32_t)4,  (int32_t)4,  (int32_t)16, tmp28, tmp30, kScale, 1);
...
ScaleUp1( (int32_t)100, tmp6,  kScale);
...
Relu2( (int32_t)1,  (int32_t)100, tmp38, tmp41, kScale, 1);
